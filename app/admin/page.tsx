...
export default function AdminPage() {
    ...
    return (
        <div className="min-h-screen bg-[#F9F9F9] font-['Malgun_Gothic']">
            <AdminNavBar />
            <div className="max-w-7xl mx-auto py-10 px-4">
                <div className="mb-8">
                    <h1 className="text-3xl font-bold text-[#0A192F]">오늘의 고인 / 에디터 픽</h1>
                    <p className="text-gray-500 mt-2">메인 페이지에 노출될 기사를 선정하고 관리하세요.</p>
                </div>
